...
namespace HolocronProject.Web.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<Data.Models.Account> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            var isBanned = this.accountsService.IsAccountBanned(Input.UserName);
            if (isBanned)
            {
                ModelState.AddModelError(string.Empty, "The account has been banned.");
                return Page();
            }

            var user = _userManager.FindByNameAsync
                            (Input.UserName).Result;
            if (user != null)
            {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Account logged in.");
                ...
                {
                    _logger.LogWarning("Account account locked out.");
